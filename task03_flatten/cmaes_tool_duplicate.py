...
def write_code(file_id, code_file, tool_file, load_tool_file, plan_file, template_file='cmaes_tool_multiprocess.py'):
    ...
    tool = scene.add_entity(
        morph = gs.morphs.Mesh(
            file=\"{{}}/task03_flatten_tools/{file_id}.obj\".format(project_path),
            scale=({s1}, {s2}, {s3}),
            pos=({p1}, {p2}, {p3}),
            euler=({e1}, {e2}, {e3}),
            fixed=False,
...
prefix = "/home/xhrlyb/Projects/FuncAny/task03_flatten_tools/"
...
for i in range(10):
    ...
    template_file = "/home/xhrlyb/Projects/FuncAny/task03_flatten/cmaes_tool_multiprocess.py"
