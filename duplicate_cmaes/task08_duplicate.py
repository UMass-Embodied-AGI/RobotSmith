...
code_file = prefix + "task08_cmaes.py"
tool_file = unity_prefix + "task08.obj"
load_tool_file = "task08.py"
plan_file = prefix + "task08_init_traj.txt"
template_file = "/home/xhrlyb/Projects/FuncAny/task08_cutting/cmaes_tool_multiprocess.py"
file_id = '_blenderkit08'
...
tool_placement = get_tool_placement(prefix + 'task08.py')
