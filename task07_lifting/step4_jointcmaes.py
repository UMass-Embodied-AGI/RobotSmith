...
class LiftingEnvURDFTool(LiftingEnv):
    ...
    def evaluate(self, trajs, close_gripper=[], scales = []):
        ...
        self.reset()
        self.save_img("init",iter=self.iter)
        scale = np.array([[0.8, 1, 1],[1,1,0.7],[2,1,1]])
        #breakpoint() 
        #self.bowl_lifter.set_links_scale(scale)
        self.scene.step()
        self.save_img("init",iter=self.iter)
...
if __name__ == "__main__":
    option = "evaluation" # "training"

    if option == "evaluation":
        env = LiftingEnvURDFTool()
        env.build_scene_for_evaluation()
        env.reset()
        env.save_img(iter = 0)
        #breakpoint()
        trajs = [(0.17,0.2,0.1),(0.17,0.2,0.005), (0.17,0.2,0.1), (0.17,0.2,0.2), (0.3,0.2,0.2), (0.4,0.2,0.2), (0.475,0.2, 0.2), (0.465,0.2,0.1), (0.455,0.2,0.01),(0.455,0.03,0.01),(0.455,0.03,0.1), (0.455,0.03,0.2)]
        ...
        dim, rng, sigma, n_envs, iters = 36, 0.06, 0.02, 3, 150 # range:0.06 sigma: 0.03
        initial_params = [(0.15,0.2,0.005),(0.15,0.2,0.005), (0.15,0.2,0.1), (0.15,0.2,0.2), (0.3,0.2,0.2), (0.4,0.2,0.2), (0.475,0.2, 0.2), (0.465,0.2,0.1), (0.455,0.2,0.01),(0.455,0.03,0.01),(0.455,0.03,0.1), (0.455,0.03,0.2)]
